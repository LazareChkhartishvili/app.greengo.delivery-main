...
export const schema = z.object({
  ...
  address_ka: z.string(),
  address_en: z.string(),
  address_latitude: z.string(),
  address_longitude: z.string(),
  phone: z.string(),
  email: z.string(),
  soc_facebook: z.string(),
  soc_instagram: z.string(),
  soc_youtobe: z.string(),
  picture: z.string(),
  show_count: z.string(),
...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  {
    ...
    cell: ({ row }) => {
      console.log(
        `Company ${row.original.name_ka} status:`,
        row.original.status,
        'type:',
      ...
      <DropdownMenu>
        <div className="flex justify-end">
          ...
          <DropdownMenuContent align="end" className="w-32">
            <DropdownMenuItem
              onClick={() =>
                (window.location.href = routes.products.products(row.id))
              }
            ...
            <DropdownMenuItem
              onClick={() =>
                (window.location.href = routes.company.editCompany(row.id))
              }
              onSelect={(e) => e.preventDefault()}
            >
              რედაქტირება
    ...
    if (active && over && active.id !== over.id) {
      setData((prevData) => {
        ...
        api.services.company
          ...
          .catch((error) => {
            console.error('Error dragging companies:', error);
          });
        return newData;
      });
    }
