import { DataTable } from '@/components/dashboard/settings/category/data-table';
...
async function RolePage() {
  ...
  const data = await api.services.category.getCategory(token);
  return (
    <>
      ...
      <Suspense fallback={<TableSkeleton />}>
        <DataTable token={token} data={data.data} />
      </Suspense>
    </>
  );
}
